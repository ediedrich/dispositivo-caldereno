...
ediciones leídas hasta 1946. \textbf{Reaparece en 1947, ya en el barrido}: el plan de obras de
la Administración de Vialidad consigna un «\textit{Puente S/Río La Caldera. Obras de arte Luz 150
mts.}» por \$690.000 (apéndice \ref{cap:cronologia}, verificado sobre el facsímil). Tampoco de
ése consta la ejecución (lámina \ref{fig:votado}). \pendiente{ejecución efectiva del plan de
