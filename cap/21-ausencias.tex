...
trece nóminas con que el Estado provincial nombró las unidades de este departamento entre 1909 y
1948 ---policía, Código Rural, circuitos electorales--- y las cruza con los dos nomencladores
...
Sierra. \textbf{Y veintiuno de los veinticuatro seguían en la nómina electoral de 1948}, entre ellos todos los
que acaban de nombrarse salvo Las Garrapatas, que esa lista incluye dentro de «Monte de las
Garrapatas»; los otros dos que faltan de ella son Bandera Angosta y Candelaria.
...
borraron entre dos formularios, y el segundo de los dos es posterior a 1948.
\end{cautela}
...
que no dejó rastro, otra que sí se construyó en 1948--1949 (capítulo \ref{cap:siglo}) y un guarda sanitario a sueldo provincial (capítulo \ref{cap:presencia}), y
...
\begin{figure}[p]
\centering
\includegraphics[width=\textwidth,height=0.84\textheight,keepaspectratio]{fig-fracciones.png}
\caption[Las tres fracciones censales del departamento, 2022]{\textbf{Las tres fracciones
censales del departamento, 2022.} A: población de 15 a 29 años; B: viviendas sin hogar
residente; C: hogares sin agua por red pública; D: las tres fracciones en números. La fracción
66077-03, el sector oriental donde están El Gallinato y su escuela, tiene la menor proporción de
población joven, la mayor de viviendas vacías y la peor cobertura de red; son 764 personas, y un
puñado de casos mueve varios puntos. La escuela es el punto del Mapa Educativo Nacional, que la
registra como «Ex Nº 198»; este libro la cita por su número actual, 4118. Elaboración propia con
el Censo 2022 (INDEC, procesamiento Redatam por radio, septiembre de 2026), la cartografía de
radios corregida por CEUR-CONICET, la red vial y el Mapa Educativo Nacional del IGN y BAHRA;
dibujo de \texttt{scripts/mapa\_fracciones.py} sobre \texttt{datos/censo\_tablas/fracciones\_2022.csv}
del repositorio \texttt{mapas\_caldera} (apéndice \ref{cap:fuentes}).}\label{fig:fracciones}
\end{figure}
