...
\subsection*{Cómo se omite: cinco mecanismos}

\begin{ficha}{Los cinco mecanismos, del más neto al más difuso}
\begin{enumerate}[leftmargin=*,nosep]
...
Los cinco van de «no está» a «está y no se encuentra», «está y no donde el acto dice», «no
existe porque nunca se escribió» y «existe y se paga». \textbf{Sólo el cuarto es ausencia de
documento en sentido propio}, y es a la vez el más interesante y el menos demostrable: probar
...
Ésta es la propiedad que ordena a los otros cuatro mecanismos, y conviene enunciarla sola.
...
con un acto de la misma época que reserve su criterio para que el contraste se disuelva. Este
libro no lo tiene, pero tampoco leyó de corrido el segundo semestre de 1922 ni nada entre
1949 y 2012, de modo que \textbf{la afirmación fuerte ---que la opacidad de criterio es algo que
