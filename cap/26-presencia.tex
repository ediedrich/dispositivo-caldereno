...
\addlinespace
1935 & \textbf{Estación sanitaria tipo «B»} en Caldera, dentro del plan de obras públicas por empréstito (Ley 158) & \textbf{\$18.360} & En el cuadro de la ley. \textbf{Sin rastro hasta 1946}; la que se construye en 1948--1949 es otra \\
\addlinespace
...
en las ediciones leídas de 1923 a 1945}. Lo que sí aparece, en febrero de 1936, es un
...
\textbf{Hubo una promesa de estación sanitaria que no dejó rastro en el período}, y un guarda
sanitario por treinta días.
...
\textbf{Y conviene decir qué pasó después, porque cambia la lectura de la salud.} Fuera de la
ventana de este capítulo, el archivo registra una estación sanitaria que sí se construyó, con otro
origen: la Ley 834 de presupuesto de 1947 destina, con fondos de la Ley 770, \$370.000 a estaciones
sanitarias en seis localidades, entre ellas La Caldera; el decreto 10668 de julio de 1948 la
adjudica, un decreto de enero de 1949 certifica \$27.024,10 de trabajos ejecutados, y en 1950 se
devuelven las garantías, que es la recepción definitiva (capítulo \ref{cap:siglo} y apéndice
\ref{cap:cronologia}). \textbf{La de 1935 no dejó rastro; la de 1947 llegó.} Una versión anterior
de este capítulo decía, sin fecha, que la estación sanitaria no dejó rastro. La lámina
\ref{fig:votado} pone las dos en la misma escala que el resto de lo que se votó.

\begin{figure}[p]
\centering
\includegraphics[width=\textwidth,height=0.84\textheight,keepaspectratio]{fig-votado-llegado.png}
\caption[Lo que se votó y lo que llegó, 1929--1949]{\textbf{Lo que se votó y lo que llegó,
1929--1949.} Cada punto es un acto que destina plata a una cosa material del departamento, en
escala logarítmica, con el estado en que el archivo lo deja: entregado o certificado, liquidado sin
constancia de obra terminada, autorizado, en un plan de obras o presupuestado y sin rastro
posterior. Los actos de 1947 a 1949 salen del barrido sin lectura sobre la imagen; la cronología
dice cuáles se verificaron sobre el facsímil. Elaboración propia; dibujo de
\texttt{scripts/grafico\_votado.py} sobre \texttt{datos/fiscal/votado\_ejecutado.csv}, que cita
para cada fila su lugar en este libro, del repositorio \texttt{mapas\_caldera} (apéndice
\ref{cap:fuentes}).}\label{fig:votado}
\end{figure}
