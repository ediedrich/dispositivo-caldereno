...
Dos de ellas, \textbf{la 2.028 (12 de noviembre) y la 2.032 (10 de diciembre)}, están en la copia de
trabajo del autor y se leyeron enteras al cierre ---46 y 32 páginas---: ninguna nombra al
departamento, y la única pieza que toca su sistema de ríos es la defensa del Mojotoro de 1943 que
el capítulo \ref{cap:siglo} incorpora. \textbf{Las 2.029, 2.030 y 2.031, del 19 de noviembre al 3
de diciembre, no se obtuvieron} y se cuentan como no leídas. Caen, además, en los meses en que pudo
haberse dispuesto la intervención de la comuna que el capítulo \ref{cap:opacidad} no logra
fechar, y el apéndice \ref{cap:pedidos} las pide. \textbf{Quedan así ocho
números ausentes ---1.095, 1.305, 1.356, 1.512, 1.564 y del 2.029 al 2.031--- y cinco presentes
pero en blanco ---1.312, 1.318, 1.320, 1.323 y 1.327---: 1.490 leídos}. Del 1.512 y el 1.564, además, \textbf{el índice del propio repositorio no registra} el
...
diciembre o la primera de enero, y los tres de 1943 caen en las semanas previas al cierre del
